# upgrade_version/test_upgrade_agent.py
...
# scripts 폴더는 없음. upgrade_version 내부 모듈 사용
from upgrade_version import version_upgrade_agent as agent

# ✅ 하위의 모든 버전 폴더(2.7.1, 3.x, …)를 자동 스캔
DEFAULT_SEARCH_DIRS = [
    str((ROOT / "examples" / "version").resolve()),
]
