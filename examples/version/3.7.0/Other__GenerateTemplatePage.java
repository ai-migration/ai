...
public class GenerateTemplatePage extends WizardPage {
	...
	private void createNoteControl(Composite control){
		...
		generateGroup.setText(DeviceAPIMessages.FILES_TABLE_VIEWER_CONTROL_CHECKBOX);
	...
	private void createWebNoteControl(Composite control){
		...
		generateGroup.setText(DeviceAPIMessages.CREATE_WEB_PROJECT_CHECKBOX_BUTTON_TEXT);	
