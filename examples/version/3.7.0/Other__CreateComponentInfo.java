...
public class CreateComponentInfo{
	...
	public static void main(String[] args) throws Exception{
		try{
			//컴포넌트 정보 엑셀 파일 경로			
			String readFilePath = "C:\\eclipse-rcp-neon-3-win32\\workspace\\egovframework.mdev.imp.commngt\\examples\\componentsMobile.xls";
			//컴포넌트 정보 properties, java, xml 파일 생성 경로
			String generateFilePath="C:\\eclipse-rcp-neon-3-win32\\workspace\\egovframework.mdev.imp.commngt\\examples";
