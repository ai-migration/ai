...
public class ERDPreferencePage extends PreferencePage implements IWorkbenchPreferencePage {
	...
	protected Control createContents(Composite parent) {
		...
		showGrid = new BooleanFieldEditor(DBPlugin.PREF_SHOW_GRID, DBPlugin.getResourceString("preference.layout.showGrid"), layoutGroup);
		gridSize = new SpinnerFieldEditor(DBPlugin.PREF_GRID_SIZE, DBPlugin.getResourceString("preference.layout.gridSize"), 1, 100, layoutGroup);
		snapToGeometry = new BooleanFieldEditor(DBPlugin.PREF_SNAP_GEOMETRY, DBPlugin.getResourceString("preference.layout.snapToGeometry"), layoutGroup);
		...
		showNotNull = new BooleanFieldEditor(DBPlugin.PREF_SHOW_NOT_NULL, DBPlugin.getResourceString("preference.diagram.showNotNull"), diagramGroup);
