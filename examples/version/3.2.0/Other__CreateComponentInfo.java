...
public class CreateComponentInfo{
	...
	public static void main(String[] args) throws Exception{
		try{
			//컴포넌트 정보 엑셀 파일 경로
			String readFilePath = "C:\\eGovRCP\\workspace\\egovframework.mdev.imp.commngt\\examples\\componentsMobile.xls";
			//컴포넌트 정보 properties, java, xml 파일 생성 경로
			String generateFilePath="C:\\eGovRCP\\workspace\\egovframework.mdev.imp.commngt\\examples";
