...
public class TemplateController implements IGenerator {
	...
	public String generate(Object element) throws Exception {
		...
		// Import 구문 생성
		String ipt = null;
		ArrayList<String> iptList = new ArrayList();
		GenUtil
				.addImportSyntaxForSuper(iptList, cls.getSuperClasses(),
						basePkg);
		GenUtil.addImportSyntaxForImpl(iptList, cls
				.getAllImplementedInterfaces(), basePkg);
		GenUtil.addImportSyntaxForAttributtes(iptList, cls.getAllAttributes(),
				basePkg);
		GenUtil.addImportSyntaxForOperations(iptList, basePkg, cls
				.getAllOperations());

		/**************************** 스테레오타입 로직 삽입구 시작 ***************************/
		Type relatedType = GenUtil.getTypeOfRelatedStereotype((Type) cls,
				"Service");
		String svcNm = null;
		...
		GenUtil.addImportSyntax(iptList,
