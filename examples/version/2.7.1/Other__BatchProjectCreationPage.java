    ...
    private void createMavenSettingGroup(Composite container) {
        ...
        groupIdText =
            IdeUIUtil.createTextField(mavenGroup,
                BatchIdeMessages.wizardsPagesBProjectCreationPage15);
        ...
        artifactIdText =
            IdeUIUtil.createTextField(mavenGroup,
                BatchIdeMessages.wizardsPagesBProjectCreationPage16);
        ...
        versionCombo =
            IdeUIUtil.createComboField(mavenGroup,
                BatchIdeMessages.wizardsPagesBProjectCreationPage17);
