...
public class CreateComponentInfo{
	...
	public static void main(String[] args) throws Exception{
		try{
			//컴포넌트 정보 엑셀 파일 경로
			String readFilePath = "C:\\EGovPDE\\workspace\\egovframework.mdev.imp.commngt\\examples\\components.xls";
			//컴포넌트 정보 properties, java, xml 파일 생성 경로
			String generateFilePath="C:\\EGovPDE\\workspace\\egovframework.mdev.imp.commngt\\examples";
...
//				System.out.println("0-->"+category_nam          );
//				System.out.println("1-->"+category_des          );
//				System.out.println("2-->"+category_Component_nam);
//				System.out.println("3-->"+category_Component_des);
//				System.out.println("4-->"+category_Component_pac);
//				System.out.println("5-->"+category_Component_use);
//				System.out.println("6-->"+category_Component_d01);
//				System.out.println("7-->"+category_Component_ver);
//				System.out.println("8-->"+category_Component_web);
//				System.out.println("9-->"+category_Component_add);
