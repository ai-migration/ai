...
public class TemplateService implements IGenerator {
	...
	public String generate(Object element) throws Exception {
		...
		GenUtil.addImportSyntaxForImpl(iptList, itfc.getUsedInterfaces(),
				basePkg);
		GenUtil.addImportSyntaxForAttributtes(iptList, itfc.getAllAttributes(),
				basePkg);
		GenUtil.addImportSyntaxForOperations(iptList, basePkg, itfc
				.getAllOperations());
		...
		// 멤버변수 구문
		String member = GenUtil.getMemberSyntaxForInterface(itfc
				.getAllAttributes());

		// 메소드 구문
		String method = GenUtil.getOperationSyntaxForInterface(itfc
				.getAllOperations());
