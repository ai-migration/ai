...
public class EgovMobileNewWebProjectWizard extends EgovMobileNewProjectWizard {
	...
	public EgovMobileNewWebProjectWizard() {
		...
		setDefaultPageImageDescriptor(EgovMobileIdePlugin
				.getDefault()
				.getImageDescriptor(EgovMobileIdePlugin.IMG_WEB_PROJ_WIZ_BANNER));
	}
	...
	public void addPages() {
		try {
			getContext().setDefaultExampleFile(
					MobileExampleInfo.defaultWebExample);

			IWizardPage firstPage = new MobileWebProjectCreationPage(
					"firstPage", getContext());
			addPage(firstPage);
