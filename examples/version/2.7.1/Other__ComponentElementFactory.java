...
public final class ComponentElementFactory {
	...
	private void initializeFactory() throws MalformedURLException, JDOMException, IOException, SecurityException, NoSuchFieldException, InstantiationException, IllegalAccessException {
		...
		Class cls = MobileComponentsInfo.class;
	...
	/** 필드 값 읽기 */
	private String getFieldValue(Class c, Element e, String a, String flag){
	...
	/** 필드 정보 얻기 */
	private Field getFieldInfo(Class c, Element e, String a, String flag){
		try {
	...
	/** 필드 값 문자열 얻기 */
	private String getFieldValueString(Class c, String a){
		try {
			if(a != null && a != "")
	...
	/** 컴포넌트 정보 얻기 */
	protected List<IComponentElement> getComponent(Class cls, Element category, List<Component> totalComponent, String catName) {
	...
	/** 컴포넌트 디펜던시 정보 얻기 */
	private List<Component> computeDependency(Class cls, Element element, List<Component> totalComponent){
